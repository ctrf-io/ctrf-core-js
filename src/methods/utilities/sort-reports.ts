 ...
 * 
 */
export function sortReportsByTimestamp(reports: Report[], order: SortOrder = SortOrder.DESC): Report[] {
    return [...reports].sort((a, b) => {
      ...
      const timeDiff = new Date(bTimestamp).getTime() - new Date(aTimestamp).getTime()
